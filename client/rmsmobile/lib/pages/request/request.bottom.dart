...
//   void modalAddRequest(context, String tipe, String token, String keterangan,
...
//                         print("HLLL");
//                         // print(
//                         // 'showmodal1 $token, ${_Keterangan.text}, , ${_Kategori.text}, , ${_DueDate.text},');
//                         // _modalKonfirmasi(
//                         //     context,
//                         //     token,
//                         //     'tambah',
...
//                             onPressed: () {
//                               print(
//                                   'showbottom2 $token, $tipe, $keterangan, $kategori, $duedate, $flagselesai');
...
//   void _actiontoapi(context, token, tipe, String keterangan, String kategori,
//       String duedate, String flagselesai) {
//     if (keterangan == "" || kategori == "" || duedate == "") {
//       ReusableClasses().modalbottomWarning(
//           context,
//           "Tidak Valid!",
...
//   void modalActionItem(context, String token, String keterangan,
//       String kategori, String duedate) {
//     showModalBottomSheet(
//         context: context,
//         isScrollControlled: true,
//         backgroundColor: Colors.white,
