...
router.get('/perpanjangan', function (req, res) {
    RouteToReport.getPerpanjangan(req, res);
});
...
// ! EXTERN CONTROLLER
var RouteToExtern = require('../controllers/extern.controller');
const customAuthToken = require('../middleware/custom_auth');
router.get(
    '/status-permohonan/:kodePermohonan',
    // customAuthToken,
    RouteToExtern.statusPermohonan
);
